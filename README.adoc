...
https://dev.epicgames.com/en-US/sdk[image:https://img.shields.io/badge/EOS SDK-1.19.0.3-lightblue[]]
...
define config.epic_scopes = epicapi.native.EOS_AS_FriendsList
